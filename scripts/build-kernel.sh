...
if [[ "${MAINLINE}" != "Y" ]]; then
    test -d linux-rockchip || git clone --single-branch --progress -b rk1-test https://github.com/Joshua-Riek/linux-rockchip.git linux-rockchip
    cd linux-rockchip
    ...
    test -d linux ||  git clone --single-branch --progress -b v6.7-rc3-rk3588 https://github.com/Joshua-Riek/linux.git --depth=100
    cd linux
